...
class SiteController extends AppController {
	...
	public $uses = array("AppFormSubmission","AppCmsEntry","AppCmsEntry","AppCmsLayout","AppCmsRevision","AppCmsSection");

	//SITE VARS
		public $company_property_id = 200;
		public $recaptcha_secret_key = '6LdOzMEUAAAAAN7siWw2YZO2mVuqQ4pldsXggwlK';
		public $recaptcha_site_key = '6LdOzMEUAAAAACws1FRDJwH7EPIGLWvz4zIZh3yk';
		public $cdn_link = 'https://c64e6af8028b2a9eede0-de481dc02c6a4aa7a65b513527b4544d.ssl.cf5.rackcdn.com';
	...
	public function beforeFilter() {
		...
		//SITE VARS
			$company_id = 200;
			$recaptcha_secret_key = '6LdOzMEUAAAAAN7siWw2YZO2mVuqQ4pldsXggwlK';
			$recaptcha_site_key = '6LdOzMEUAAAAACws1FRDJwH7EPIGLWvz4zIZh3yk';

		//CDN VAR
			$cdn_link = 'https://c64e6af8028b2a9eede0-de481dc02c6a4aa7a65b513527b4544d.ssl.cf5.rackcdn.com';
			$this->set('cdn_link', $cdn_link);
		...
		if(isset($_POST['g-recaptcha-response'])) {
			...
			$verifyCaptchaResponse = file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=6LdOzMEUAAAAAN7siWw2YZO2mVuqQ4pldsXggwlK&response='.$_POST['g-recaptcha-response']);
						...
						if((strtotime("now")-$this->data['pagetime'])>=3) {
							...
							// UTMs
								...
								//Save Database
									...
									$this->request->data['app_company_property_id']=200;
		...
		## Logic
			...
			//Cms Entry
				...
				$cms_entry=$this->AppCmsEntry->query('
					...
					AND
						AppCmsEntry.app_company_property_id = 107
					AND
						AppCmsEntry.pretty_url="/"
				');
